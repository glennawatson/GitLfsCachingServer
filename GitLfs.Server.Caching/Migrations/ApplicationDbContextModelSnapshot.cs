// <copyright file="ApplicationDbContextModelSnapshot.cs" company="Glenn Watson">
...
namespace GitLfs.Server.Caching.Migrations
{
    ...
    internal class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
                ...
                b =>
                    {
                        ...
                        b.Property<string>("Href").IsRequired();
            ...
            modelBuilder.Entity(
                "GitLfs.Server.Caching.Models.ApplicationUser",
                b =>
                    {
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityRole").WithMany("Claims")
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("GitLfs.Server.Caching.Models.ApplicationUser").WithMany("Claims")
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("GitLfs.Server.Caching.Models.ApplicationUser").WithMany("Logins")
                            .HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade);
                    });
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityRole").WithMany("Users")
                            .HasForeignKey("RoleId").OnDelete(DeleteBehavior.Cascade);

                        b.HasOne("GitLfs.Server.Caching.Models.ApplicationUser").WithMany("Roles")
                            .HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade);
                    });
        }
    }
